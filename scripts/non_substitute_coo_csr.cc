...
#define s_3(n, i, k)   rowptr(i) = min(rowptr(i),k) 
#define s3(__x0, a1, tv2, tv3, __x4, a3, __x6, a5, __x8)   s_3(a1, a3, a5);
#define s_4(n, i)   rowptr(i) = min(rowptr(i),P1(row1(n), col1(n))) 
#define s4(__x0, a1, tv2, tv3, __x4, a3, __x6, __x7, __x8)   s_4(a1, a3);
#define s_5(n, i, k)   rowptr(i + 1) = max(rowptr(i + 1),k + 1) 
#define s5(__x0, a1, tv2, tv3, __x4, a3, __x6, a5, __x8)   s_5(a1, a3, a5);
#define s_6(n, i)   rowptr(i + 1) = max(rowptr(i + 1),P1(row1(n), col1(n)) + 1) 
#define s6(__x0, a1, tv2, tv3, __x4, a3, __x6, __x7, __x8)   s_6(a1, a3);
#define s_7(e1, e2)   if ( not (rowptr(e1) <= rowptr(e2))){rowptr(e2) = rowptr(e1);} 
#define s7(__x0, a1, __x2, a3, __x4, __x5, __x6)   s_7(a1, a3);
#define s_8(n, i, k)   ACSR(i,k) = ACOO(n ) 
#define s8(__x0, a1, tv2, tv3, __x4, a3, __x6, a5, __x8)   s_8(a1, a3, a5);
...
#define P1_4(__tv0, __tv1, __tv2, __tv3) P1(__tv2, __tv3)
#define col1(t0) col1[t0]
#define col1_1(__tv0, __tv1) col1(__tv1)
#define col2(t0) col2[t0]
#define col2_5(__tv0, __tv1, __tv2, __tv3, __tv4, __tv5, __tv6, __tv7) col2(__tv7)
#define row1(t0) row1[t0]
#define row1_0(__tv0, __tv1) row1(__tv1)
#define rowptr(t0) rowptr[t0]
#define rowptr_6(__tv0, __tv1, __tv2, __tv3, __tv4, __tv5) rowptr(__tv5)
#define rowptr_7(__tv0, __tv1, __tv2, __tv3, __tv4, __tv5) rowptr(__tv5 + 1)
...
if (NR >= 1 && NC >= 1) {
  for(t2 = 0; t2 <= NNZ-1; t2++) {
    if (row1_0(t1,t2) >= 0 && NC >= col1_1(t1,t2)+1 && col1_1(t1,t2) >= 0 && NR >= row1_0(t1,t2)+1) {
      ...
      if (P0_2(t1,t2,t3,t4) == t3) {
        t6=P0_2(t1,t2,t3,t4);
        if (P1_4(t1,t2,t3,t4) >= rowptr_6(t1,t2,t3,t4,t5,t6) && rowptr_7(t1,t2,t3,t4,t5,t6) >= P1_4(t1,t2,t3,t4)+1) {
          t8=P1_4(t1,t2,t3,t4);
          if (col2_5(t1,t2,t3,t4,t5,t6,t7,t8) == col1_1(t1,t2)) {
            s8(8,t2,t3,t4,0,t6,0,t8,0);
          }
        }
      }
    }
