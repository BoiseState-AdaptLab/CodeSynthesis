...
#define s_3(n, ii, jj, kk)   mz3d(n)=z3d(P0_INV(n)) 
...
#define s_5(n, ii, jj, kk)   mrow3(n)=row3d(P0_INV(n)) 
...
#define s_7(n, ii, jj, kk)   mcol3(n)=col3d(P0_INV(n)) 
...
#define P0_3(__tv0, __tv1, __tv2, __tv3, __tv4, __tv5, __tv6, __tv7) P0_INV(__tv1)
...
PermuteSimpSizeOpt<decltype(P0Comp)>* P0 = new PermuteSimpSizeOpt <decltype(P0Comp)>(P0Comp,nnz);
