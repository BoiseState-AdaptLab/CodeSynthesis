...
Set *MinimalSatisfiablity::getDomain(Relation *relation, Term *unknownTerm,
    ...
    while(conj!=end){
        ...
        std::unordered_set<TupleVarTerm*> tupleConstraintVar;
